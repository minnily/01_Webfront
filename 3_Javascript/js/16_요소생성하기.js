...
//createBox 버튼 클릭 시 div.box 를 생성하여 container에 마지막 자식으로 추가
...
/* 
    * 요소. classList : 요소의 클래스 목록 -> 클래스 존재여부, 추가, 제거 등을 할 수 있음

    * 요소.classList-> 요소 목록이 배열 형식으로 반환

    * 요소.classList.contains("클래스명") -> (내가 전달한) 클래스가 있으면 true, 없으면 false
