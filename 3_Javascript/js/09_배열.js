...
function check1(){
    ...
    //배열 선언 방법 확인
    const arr1 = new Array(); //0칸짜리 배열
    const arr2 = new Array(3); //3칸짜리 배열
    const arr3 = []; //0칸짜리 배열 (배열기호로 만들기)
    const arr4 = ["사과","바나나","딸기"]; // 문자열 3개를 넣었으니 3칸 짜리 배열
...
function check2(){
    ...
    // idex : 배열의 각 칸을 구분하는 번호
    // 배열 요소== 배열의 각 칸

    //for문 사용안했을 때 초기화 하는 방법
    const arr1 =[];
    arr1[0] = 0;
    arr1[1] = 10;
    arr1[2] = 20;
...
//2부터 2씩 증가하는 수를  
//5행 5열 배열의 모든 요소에서 차례대로 대입하고 출력하기
