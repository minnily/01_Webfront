...
const result1 = document.getElementById("result1"); //result
...
function checkFn3(){
    ...
    //문자열 전체를 백틱(`)으로 감싼후 변수, 연산결과 등이 출력되는 자리에 
    //${변수명} 또는 ${연산식}을 작성
...
function minus4() {
    ...
    //count4 =count4 - value; 밑에랑 같은 표현인데 복합 연산자로 사용하는 방법
...
function checkFn5 (){
    ...
    console.log(`13은 1부터 10 사이에 수가 맞는가? ${bool3}`);
